package com.omtorney.doer.data.local.datastore
...
class SettingsStore @Inject constructor(
    ...
    val noteSeparatorState: Flow<Boolean> = dataStore.data.map { preferences ->
    ...
    val noteSeparatorSize: Flow<Int> = dataStore.data.map { preferences ->
    ...
    val accentColor: Flow<Long> = dataStore.data.map { preferences ->
    ...
    val secondaryColor: Flow<Long> = dataStore.data.map { preferences ->
